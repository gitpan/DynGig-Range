...
DynGig::Range::CLI::String - CLI for Range::String - expand/digest/count

=cut
package DynGig::Range::CLI::String;
...
=head1 EXAMPLE
 ...
 use DynGig::Range::CLI::String;

 DynGig::Range::CLI::String->main( delimiter => "\n" );
